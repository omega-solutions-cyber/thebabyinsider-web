      ...
      <Container className="mt-5">
        <article>
          <header>
            ...
            <h1 className="text-ink mt-2 font-sans text-[1.75rem] leading-[1.15] font-extrabold sm:text-[2.25rem]">
              {article.title}
            </h1>
          ...
          <div className="prose prose-editorial prose-headings:font-sans prose-headings:font-bold prose-h2:mt-10 prose-h2:text-[1.4rem] prose-h3:text-[1.1rem] prose-a:font-medium prose-li:leading-relaxed max-w-none">
            <MDXContent
              code={article.body}
              components={{
