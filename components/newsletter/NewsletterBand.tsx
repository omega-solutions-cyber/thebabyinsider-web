...
export function NewsletterBand({
  ...
  return (
    <section aria-labelledby={`nl-${source}`} className={cn('bg-accent text-white', className)}>
      <div className="grid items-center gap-6 px-6 py-8 sm:px-10 md:grid-cols-2 md:gap-12">
        <div>
          <h2
            id={`nl-${source}`}
            className="flex items-center gap-3 font-sans text-xl font-extrabold tracking-[0.06em] uppercase"
          >
