    ...
    <>
      ...
      <Container className="mt-5 pb-6">
        <header className="border-rule border-b pb-6">
          <h1 className="text-ink font-sans text-[1.75rem] leading-tight font-extrabold uppercase sm:text-[2.1rem]">
            {page.title}
          </h1>
        ...
        <div className="prose prose-editorial prose-headings:font-sans prose-headings:font-bold prose-h2:mt-9 prose-h2:text-[1.3rem] mt-8 max-w-none">
